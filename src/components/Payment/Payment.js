...
export default function Payment() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://capstone-backend-8tak.onrender.com/order/add",
        pdObject
      );
      res &&
        Swal.fire({
  ...
  return (
    <>
      <GlobalNavbar />
      <div
        className="mt-5 pt-5 mb-5 pt-3 d-flex justify-content-center align-content-center"
        id={style.paymentContainer}
      >
        <div
          className="card shadow"
          style={{ width: "18rem" }}
          id={style.imgContainer}
        >
        ...
        <div className="shadow-lg" id={style.payBox}>
          ...
          <p className="mt-2" id={style.payMethd}>
            ...
            <div className="row">
              <div className="col-md-6">
                ...
                <form className="row g-3 mt-3">
                  ...
                  <div className="col-12">
                    <Link to="/pdDetails">
                      <button type="submit" className={style.returnBtn}>
                        Return to store
                      </button>
                    </Link>
                  </div>
