  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://capstone-backend-8tak.onrender.com/user/register",
        userObj
      );
        ...
        <div className="container form__container">
          ...
          <div className="signup__right">
            <form className="container p-4">
              ...
              <p className="fl__semiTitle">
                Sign up to continue to our application
              </p>
              <div className="mb-2">
                <label htmlFor="exampleInputl1" className="form-label lavel">
                  Username
                </label>
                <input
                  type="text"
              ...
              <div className="mb-1">
                <label htmlFor="exampleInput1" className="form-label lavel">
                  User Image
                </label>
                <input
                  type="file"
