              ...
              <div className={style.footerWdget}>
                ...
                <div className={style.footerText}>
                  <p className="text-sm-start">
                    E-Sheba is here to give you the best service with refundable
                    policies, here you may get all kind of services as you see
                    fit.
                  </p>
                </div>
