  ...
  const handleUpdateSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(
        "https://capstone-backend-8tak.onrender.com/user/update/" + user._id,
        userObj
      );
    ...
    <section className="mt-5 pt-5 mb-4 shadow" id={style.userDash}>
      <div className={style.titleText}>
        <h2 className={style.title}>
          User<span className={style.titleHalf}> Profile</span>
        </h2>
      </div>
      ...
      <div className="container border h-75 rounded " id={style.userBox}>
        <div className="">
          <div className="d-flex justify-content-end align-items-center mt-2 mb-4">
            {update ? (
              <button
                className={style.userDash__edit}
          ...
          <div className="d-flex justify-content-center align-items-center mt-3 mb-4">
            {update ? (
              <>
                <label htmlFor="inputUserImg" className="form-label">
                  User Image
                </label>
                <br />
                <input
